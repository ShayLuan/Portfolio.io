  ...
  return (
    <section id="languages" className="py-16 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-400" style={{ WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Communication Languages</h2>
          <p className="mt-4 text-lg text-gray-300 max-w-3xl mx-auto">
            Learning languages is a passion of mine
          </p>
        </motion.div>
        ...
        {currentlyLearning.length > 0 && (
          ...
          >
            <h3 className="text-lg font-semibold text-gray-300 mb-4">Currently Learning</h3>
